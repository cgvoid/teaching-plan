...
function constructTimetable(olddata, newdata){
    ...
    for(var id in newdata){
        var uri = null, content = null, day = 0;
        ...
        if(newdata.length < 13){
            ...
            day = Math.floor(id/Math.round(newdata.length/13)) + 1;
        }
        //console.log(day);
        if(day <= 13){
            timeSlot = document.getElementById('week'+day);
        }
        else{
            timeSlot = document.getElementById('week'+13);
        }
